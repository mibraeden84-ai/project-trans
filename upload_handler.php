    ...
    try {
        switch ($uploadType) {
            ...
            case 'firmware':
                ...
                if (!$modelId) throw new Exception('Model is required for firmware');
            ...
            case 'manual':
                ...
                if (!$modelId) throw new Exception('Model is required for manuals');
            ...
            case 'software':
                ...
                if (!$modelId) throw new Exception('Model is required for software');
